    ...
    <>
      <header className="header">
        <div className="hdrInner">
          <Link id="logo" href="/" aria-label="Logo">
            <svg
              viewBox="0 0 203 62"
              fill="none"
              aria-hidden="true"
